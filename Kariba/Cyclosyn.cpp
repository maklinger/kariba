...
static double arg[47] = {
    0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.005, 0.01, 0.03, 0.05, 0.07,
...
static double var[47] = {
    -1.002e+0, -9.031e-1, -7.696e-1, -6.716e-1, -5.686e-1, -4.461e-1, -3.516e-1,
    -2.125e-1, -1.537e-1, -1.192e-1, -8.725e-2, -4.383e-2, -3.716e-2, -4.528e-2,
    -5.948e-2, -7.988e-2, -1.035e-1, -1.296e-1, -1.586e-1, -1.838e-1, -3.507e-1,
    -5.214e-1, -6.990e-1, -8.861e-1, -1.073e+0, -1.267e+0, -1.470e+0, -1.670e+0,
    -1.870e+0, -2.073e+0, -2.279e+0, -2.483e+0, -2.686e+0, -2.893e+0, -3.097e+0,
    -3.303e+0, -3.510e+0, -3.717e+0, -4.550e+0, -5.388e+0, -6.230e+0, -7.075e+0,
...
// distribution
double Cyclosyn::emis_integral(double nu, double gmin, double gmax,
...
double Cyclosyn::abs_integral(double nu, double gmin, double gmax,
                              gsl_spline *derivs,
        ...
        if (log10(emis) < -50. || log10(abs) < -50.) {
            ...
            if (counterjet == true) {
                ...
                if (tsyn_obs >= 1.) {
                    ...
                    absfac_obs = tsyn_obs - pow(tsyn_obs, 2.) / 2. +
                                 pow(tsyn_obs, 3.) / 6.;
                }
                num_phot_obs[k + size] =
                    2. * r * z * absfac_obs * epsasyn * pow(dopfac_cj, dopnum);
            } else {
                num_phot_obs[k + size] = 0.;
            }
        }
