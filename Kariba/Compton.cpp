...
static double Te_table[15] = {19.999, 30.,  50.,   70.,   90.,
                              120.,   150., 200.,  280.,  400.,
                              600.,   900., 1300., 1800., 2500.001};
static double tau_table[15] = {0.04999, 0.07, 0.1,  0.19, 0.27,
                               0.38,    0.54, 0.76, 0.94, 1.08,
                               1.34,    1.75, 2.1,  2.6,  3.0001};

static double esc_table_sph[225] = {
    0.02,  0.07,  0.17,  0.27, 0.33,  0.4,   0.45,  0.45,  0.55,  0.55,  0.54,
    0.51,  0.48,  0.55,  0.55, 0.02,  0.07,  0.18,  0.275, 0.33,  0.4,   0.45,
    0.47,  0.55,  0.53,  0.56, 0.51,  0.5,   0.55,  0.55,  0.02,  0.07,  0.18,
    0.275, 0.34,  0.4,   0.45, 0.47,  0.55,  0.54,  0.52,  0.51,  0.53,  0.55,
    0.58,  0.025, 0.085, 0.18, 0.275, 0.35,  0.4,   0.45,  0.47,  0.55,  0.54,
    0.59,  0.57,  0.5,   0.55, 0.6,   0.028, 0.085, 0.2,   0.275, 0.35,  0.4,
    0.45,  0.49,  0.54,  0.54, 0.6,   0.59,  0.53,  0.55,  0.65,  0.035, 0.09,
    0.21,  0.29,  0.35,  0.4,  0.45,  0.49,  0.55,  0.57,  0.58,  0.6,   0.53,
    0.55,  0.7,   0.045, 0.12, 0.23,  0.3,   0.35,  0.41,  0.42,  0.49,  0.54,
    0.57,  0.58,  0.58,  0.5,  0.55,  0.7,   0.055, 0.135, 0.23,  0.3,   0.35,
    0.4,   0.42,  0.49,  0.52, 0.57,  0.59,  0.61,  0.58,  0.57,  0.85,  0.07,
    0.14,  0.235, 0.3,   0.35, 0.4,   0.41,  0.49,  0.5,   0.57,  0.58,  0.61,
    0.61,  0.57,  0.85,  0.08, 0.145, 0.235, 0.3,   0.35,  0.39,  0.4,   0.49,
    0.5,   0.57,  0.58,  0.63, 0.7,   0.6,   0.85,  0.09,  0.15,  0.245, 0.3,
    0.35,  0.4,   0.4,   0.45, 0.49,  0.55,  0.62,  0.64,  0.73,  0.6,   0.85,
    0.105, 0.17,  0.26,  0.31, 0.35,  0.4,   0.4,   0.45,  0.47,  0.56,  0.62,
    0.65,  0.78,  0.65,  0.85, 0.115, 0.19,  0.28,  0.32,  0.35,  0.4,   0.4,
    0.45,  0.44,  0.5,   0.67, 0.68,  0.8,   0.7,   1.,    0.14,  0.215, 0.3,
    0.34,  0.38,  0.4,   0.4,  0.45,  0.42,  0.48,  0.68,  0.73,  0.85,  0.8,
    1.,    0.16,  0.23,  0.31, 0.35,  0.38,  0.4,   0.4,   0.45,  0.42,  0.48,
    0.67,  0.78,  0.9,   0.9,  1.,
};

static double esc_table_cyl[225] = {
    0.02,  0.06,  0.22,  0.3,   0.5,   0.5,  0.57, 0.7,  0.75,  0.75,  0.75,
    0.77,  0.75,  0.76,  0.7,   0.02,  0.06, 0.19, 0.28, 0.4,   0.5,   0.57,
    0.65,  0.65,  0.75,  0.7,   0.75,  0.7,  0.7,  0.75, 0.017, 0.04,  0.17,
    0.27,  0.32,  0.5,   0.57,  0.6,   0.6,  0.7,  0.65, 0.65,  0.73,  0.67,
    0.7,   0.01,  0.04,  0.12,  0.17,  0.23, 0.35, 0.4,  0.55,  0.5,   0.55,
    0.55,  0.65,  0.7,   0.67,  0.68,  0.01, 0.04, 0.1,  0.17,  0.19,  0.28,
    0.32,  0.4,   0.45,  0.5,   0.5,   0.5,  0.68, 0.66, 0.68,  0.015, 0.04,
    0.09,  0.17,  0.19,  0.25,  0.25,  0.35, 0.45, 0.4,  0.45,  0.5,   0.64,
    0.64,  0.68,  0.02,  0.05,  0.09,  0.15, 0.17, 0.22, 0.24,  0.3,   0.35,
    0.35,  0.45,  0.4,   0.62,  0.61,  0.64, 0.02, 0.05, 0.095, 0.15,  0.17,
    0.22,  0.22,  0.25,  0.3,   0.35,  0.4,  0.38, 0.4,  0.4,   0.6,   0.024,
    0.05,  0.095, 0.14,  0.16,  0.21,  0.21, 0.25, 0.27, 0.32,  0.4,   0.42,
    0.4,   0.4,   0.5,   0.025, 0.055, 0.1,  0.15, 0.17, 0.21,  0.21,  0.25,
    0.27,  0.3,   0.35,  0.4,   0.35,  0.4,  0.43, 0.03, 0.065, 0.11,  0.15,
    0.18,  0.21,  0.21,  0.25,  0.27,  0.3,  0.35, 0.4,  0.4,   0.45,  0.47,
    0.045, 0.085, 0.135, 0.17,  0.19,  0.22, 0.24, 0.27, 0.3,   0.35,  0.4,
    0.45,  0.5,   0.5,   0.55,  0.06,  0.1,  0.16, 0.2,  0.22,  0.25,  0.26,
    0.29,  0.33,  0.35,  0.45,  0.5,   0.5,  0.55, 0.65, 0.09,  0.14,  0.2,
    0.23,  0.26,  0.29,  0.29,  0.33,  0.4,  0.4,  0.48, 0.55,  0.6,   0.65,
    0.75,  0.11,  0.165, 0.23,  0.26,  0.29, 0.31, 0.33, 0.36,  0.4,   0.45,
    0.52,  0.6,   0.65,  0.75,  0.8,
};
...
double Compton::comintegral(int it, double blim, double ulim, double enphot,
                            double enphmin, double enphmax, gsl_spline *eldis,
...
void Compton::set_tau(double n, double Te) {
    ...
    if (geometry == "sphere" && tau >= 0.05 && tau <= 3. && Te >= 20. &&
        Te <= 2500.) {
        escape_corr = gsl_spline2d_eval(esc_p_sph, Te, tau, acc_Te, acc_tau);
    } else if (geometry == "cylinder" && tau >= 0.05 && tau <= 3. &&
               Te >= 20. && Te <= 2500.) {
        ...
        std::cout
            << "Optical depth too high, assuming it's 3 for IC calculation!"
            << std::endl;
        std::cout
        ...
        std::cout
            << "Temperature too low, assuming it's 20 kev for IC calculation!"
            << std::endl;
        std::cout
            << "Don't trust the output spectrum slope and change parameters!"
            << std::endl;
...
void Compton::test() {
    std::cout << "Optical depth: " << tau << " Compton-Y: " << ypar
              << " r: " << r << " z: " << z << " angle: " << angle
