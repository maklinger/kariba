...
void velprof_iso(gsl_spline *spline) {
    ...
    static double gbx_vel_iso[54] = {
        ...
        518.283,     1325.11,     3429.81,     8975.1,      23719.5,
        63255.,      170099.,     460962.,     1.25824e+06, 3.4578e+06,
        9.5633e+06,  2.66095e+07, 7.44655e+07, 2.09528e+08, 5.92636e+08,
        1.6846e+09,  4.81148e+09, 1.38055e+10, 3.9787e+10,  1.15153e+11,
        3.34651e+11, 9.76408e+11, 2.85981e+12, 8.40728e+12, 2.4805e+13,
        7.34419e+13, 2.18185e+14, 6.50341e+14, 1.94471e+15, 5.83352e+15,
    ...
    static double gby_vel_iso[54] = {
        ...
        3.06516,  3.14611, 3.22497, 3.30189, 3.37702, 3.45046, 3.52232, 3.59270,
        3.66169,  3.72937, 3.79580, 3.86106, 3.92520, 3.98827, 4.05033, 4.11143,
...
void velprof_ad(gsl_spline *spline) {
    ...
    static double gbx_vel_ad[54] = {
        ...
        3.94364,     4.73011,     5.48892,     6.16231,     7.27006,
        8.43633,     1.01187e+01, 1.19378e+01, 1.45572e+01, 1.89648e+01,
        2.47070e+01, 2.96343e+01, 4.26328e+01, 7.1172e+01,  1.1495e+02,
        2.05019e+02, 4.31392e+02, 7.82228e+02, 1.30586e+03, 2.32905e+03,
        4.98237e+03, 7.05026e+03, 1.559e+04,   3.68259e+04, 1.07850e+05,
        2.08929e+05, 8.10435e+05, 1.51893e+06, 2.94251e+06, 7.93391e+06,
    ...
    static double gby_vel_ad[54] = {
        ...
        2.10068, 2.14966, 2.17688, 2.22041, 2.27483,  2.30748, 2.33469, 2.35646,
        2.36735, 2.37823, 2.38367, 2.38912, 2.38912,  2.38912, 2.39456, 2.39456,
...
void b_profile(double gam, double n, jet_dynpars &dyn, jet_enpars &en,
               double &field) {
    double sigma, w;
